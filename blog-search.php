...
$stmt = $db->prepare("SELECT * FROM blog_posts WHERE title LIKE ? OR content LIKE ? OR category LIKE ? ORDER BY created_at DESC");
...
<head>
    ...
    <title>Search Results - Urban Green Haven</title>
...
<body class="bg-gray-50">
    ...
    <div class="bg-primary-600 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="mt-2 text-primary-100">Showing results for: "<?php echo htmlspecialchars($query); ?>"</p>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <?php else: ?>
            <div class="text-center py-12">
                ...
                <h2 class="text-2xl font-semibold text-gray-800 mb-2">No results found</h2>
                <p class="text-gray-600">Try different keywords or check out our other blog posts.</p>
                <a href="blog.html" class="inline-block mt-4 text-primary-600 hover:text-primary-700">Back to Blog</a>
            </div>
        <?php endif; ?>
    </div>
